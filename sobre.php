    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src=".\imagens\index2.jpg" alt="carrossel1" >
                ...
                <div class="carousel-item">
                    <img src=".\imagens\index3.jpg" alt="carrossel2">
                <div class="carousel-caption">
                ...
                <div class="carousel-item">
                    <img src=".\imagens\logo3.png" alt="carrossel3" >
                    <div class="carousel-caption">
...
<!--
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item">
              <img class="first-slide" src=".\imagens\index1.jpg" alt="First slide">
              <div class="container">
            ...
            <div class="carousel-item active">
              <img class="second-slide" src=".\imagens\index2.jpg" alt="Second slide">
              <div class="container">
                <div class="carousel-caption text-right">
                  <p><a class="btn btn-lg btn-primary" href="#" role="button">Ver mais </a></p>
                </div>
            ...
            <div class="carousel-item">
              <img class="third-slide" src=".\imagens\logo3.png" alt="Third slide">
              <div class="container">
                <div class="carousel-caption text-right">
                  <p><a class="btn btn-lg btn-primary" href="#" role="button">Ver mais</a></p>
                </div>
