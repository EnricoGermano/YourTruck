...
<head>
    ...
    <link rel="stylesheet" href="./style_motora.css" />
...
<body>
    ...
    <nav class="navbar navbar-expand-custom navbar-mainbg" style="border:0px solid red;padding:0px;">
        <a class="navbar-brand navbar-logo" href="index_motorista.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="border:0px solid red;margin:0px;">
            <ul class="navbar-nav ml-auto">
				...
				<li class="nav-item <?php echo $vetor[0];?>">
                    <a class="nav-link" href="perfil_motorista.php"><i class="fas fa-user" style="font-size:15px;" ></i>Perfil</a>
                </li>
                
                <li class="nav-item <?php echo $vetor[3];?>">
                    <a class="nav-link" href="./ChatApp/chat.php"><i class="far fa-envelope" style="font-size:15px;" ></i>Mensagens</a>
                </li>
